...
editUser <- rbind(editUser,c("SJAR", 2457620.9, 2457622.0,"V"),c("BJFB",2457925,2457928,"V"),c("LPB",2457348,2457349.5,"B"),c("LPB",2457385,2457386,"R"),
                            ...
                            c("JSJA",2457899,2457900,"B"),c("JM",2458070.1,2458971.1,"B"),c("JM", 2458054.1, 2458055.1,"B"),c("OJJ",2458042.1,2458043.2,"I"),
                            c("DUBF",2457680	,2457790,"R"),c("JM",245800,245803,"B"),c("JM",2458048.1,2458049.2,"V"),c("JM",2457731.5,2457732.6,"B"),
                            c("AMID",2458073.8,2458074.8,"V"),c("AMID",2457937.0,2457938.0,"V"))
